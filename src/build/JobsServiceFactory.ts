...
export class JobsServiceFactory extends Factory{
    public static MemoryPersistenceDescriptor = new Descriptor('jobs', 'persistence', 'memory', '*', '1.0');
    public static FilePersistenceDescriptor = new Descriptor('jobs', 'persistence', 'file', '*', '1.0');
    public static MongoDbPersistenceDescriptor = new Descriptor('jobs', 'persistence', 'mongodb', '*', '1.0');
    public static ControllerDescriptor = new Descriptor('jobs', 'controller', 'default', '*', '1.0');
    public static HttpServiceV1Descriptor = new Descriptor('jobs', 'service', 'http', '*', '1.0');
