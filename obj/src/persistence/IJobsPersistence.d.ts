...
export interface IJobsPersistence {
    ...
    updatePartially(correlationId: string, id: string, values: AnyValueMap, callback: (err: any, item: JobV1) => void): void;
    startJobById(correlationId: string, id: string, timeout: number, callback: (err: any, item: JobV1) => void): void;
    startJobByType(correlationId: string, type: string, timeout: number, maxRetries: number, callback: (err: any, item: JobV1) => void): void;
